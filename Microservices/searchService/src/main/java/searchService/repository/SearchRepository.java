...
public interface SearchRepository extends JpaRepository<Search, Long> {
    ...
    @Query("select search from Search search where " +
            ...
            "and (search.child_seats in ?7)")
    List<Search> getByQuery(List<String> brands, List<String> models, List<String> classes, List<String> transmissions, List<String> gases, List<String> locations, List<Integer> childSeats);
}