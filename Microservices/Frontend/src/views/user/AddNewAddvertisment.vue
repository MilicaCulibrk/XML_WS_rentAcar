              ...
              <v-form ref="form">
                <v-row>
                  ...
                  <v-row class="mt-n8">
                    ...
                    <v-col cols="4">
                      <v-checkbox label="Do you want to include CWD option?" :v-model="selectCdw" @change="selectCdw=!selectCdw" color="primary"></v-checkbox>
                    </v-col>
                  </v-row>
                  <v-row class="mt-n8">
                    <v-col cols="4" >
  ...
  export default {
    ...
    data () {
      ...
      addvertisment: {
        ...
        plannedToCrossRule: [v => /^[0-9]*$/.test(v) || "Only numbers are allowed"],
