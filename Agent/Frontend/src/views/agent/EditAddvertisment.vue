        ...
        <v-dialog v-model="dialogEdit" max-width="1200px">
            <template #activator="{ on: dialogEdit }">
                <v-tooltip bottom color="black">
                  ...
                  dark
                  fab
                  style="margin-top: -590px; color: #ff8a65; " 
                  >
  ...
  props: {
        addvertisment: {
          ...
          methods: {
             ...
             if(this.addvertisment.vehicle_class_name==null || this.addvertisment.fuel_type_name==null || this.addvertisment.transmission_type_name==null || this.addvertisment.vehicle_class_name=="" || this.addvertisment.fuel_type_name=="" || this.addvertisment.transmission_type_name.transmission_type_name=="" || this.selectMileage=="" || this.selectChildSeats=="" || this.selectLocation=="" )    {
                ...
                for(var i2 in this.transmissionTypeItems){
                 if(this.addvertisment.transmission_type_name==this.transmissionTypeItems[i2].transmission_type_name){                        this.addvertismentUpdate.transmission_type_id = this.transmissionTypeItems[i2].id;
                    }
                } 
                ...
                this.addvertismentUpdate.owner = this.$store.state.user.username;
             ...
             this.addvertismentUpdate.price = this.addvertisment.pricelist.dailyPrice;    
               console.log(this.addvertismentUpdate);
                ...
                axios
              .put("/addvertisment", this.addvertismentUpdate)
              .then(() => {
                this.dialogEdit = false;
            ...
            axios
              ...
              .catch(error => {
                ...
                axios
                .get(
                    "/addvertisment/" + this.addvertisment.id
                )
                .then(addvertismentReal => {
                    ...
                    this.selectPrice=this.addvertismentReal.daily_price;
                ...
                .catch(error => {
                    console.log("ovde pukneeeeeeeeee");
          ...
          mounted() {
            ...
            axios
              .get(
                "/addvertisment/user/" + this.$store.state.user.username
              )
              .then(addvertisments => {
