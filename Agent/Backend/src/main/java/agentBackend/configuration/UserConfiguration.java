...
public class UserConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/h2-console/**", "/grade/**" ,"/comment/**", "/create/**", "/verify/**", "/company/**",  "/request","/request/**", "/auth/**", "/login", "/addvertisment/**", "/reservedDate/**",  "/brand/**", "/purchase/**", "/model/**", "/vehicle_class", "/fuel_type", "/transmission_type", "/login/**","/user/**","/user", "/register", "/register/**",  "/ws/**")
